...
// text_btn_u.addEventListener('click', function() {
//   console.log("Should output the rule of Username");
//   const rule = document.getElementById('rule');
//   console.log(rule.innerHTML);
//   rule.innerHTML = "1.Username must be 5 characters or longer \n Username should not contain spaces, commas, separators, equal signs and ampersand \nUsername can only use characters from the following string:\nabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^*()-_+[]{}:'|`~<.>/?";
// });
...
// text_btn_p.addEventListener('click', function() {
//   console.log("Should output the rule of Password");
//   const rule = document.getElementById('rule');
//   console.log(rule.innerHTML);
//   rule.innerHTML = "1.Password must be 5 characters or longer \n2.Password should not contain spaces, commas, separators, equal signs and ampersand \n3.Password can only use characters from the following string:\nabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!@#$%^*()-_+[]{}:'|`~<.>/? \n4.Password should incloud least one number and one letter";
// });
...
//   console.log("Should output the rule of Login or Setup");
//   const rule = document.getElementById('rule');
//   console.log(rule.innerHTML);
//   rule.innerHTML = "Is this your first time logging in?\nIf yes, please enter the username and password you would like to create\nIf not, please enter your username and password";
// });
...
function display_check_input(){
  ...
  // //if this username is new username
  // let setup = confirm('Do you want to setup by Username[',text_btn_u.value,'] Password[',text_btn_p.value,']?');
  // if (ok) {
  //   alert("Created successfully");
  //   //send username and password to list, and jump to this user page
  // }

  // //if this username in the list, but password is wrong
  // alert("Wrong Password");

  // //if username and password are correct
  // alert("Welcome");
  // //jump to this user page
}
